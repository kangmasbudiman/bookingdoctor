...
class PastbookingRecord extends FirestoreRecord {
  PastbookingRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('pastbooking');

  static Stream<PastbookingRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => PastbookingRecord.fromSnapshot(s));

  static Future<PastbookingRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => PastbookingRecord.fromSnapshot(s));

  static PastbookingRecord fromSnapshot(DocumentSnapshot snapshot) =>
      PastbookingRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static PastbookingRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      PastbookingRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'PastbookingRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is PastbookingRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createPastbookingRecordData({
  String? doctorname,
  String? clientname,
  String? doctorimage,
...
class PastbookingRecordDocumentEquality implements Equality<PastbookingRecord> {
  const PastbookingRecordDocumentEquality();

  @override
  bool equals(PastbookingRecord? e1, PastbookingRecord? e2) {
  ...
  @override
  int hash(PastbookingRecord? e) => const ListEquality().hash([
        e?.doctorname,
        e?.clientname,
        e?.doctorimage,
        e?.doctorspeciality,
  ...
  @override
  bool isValidKey(Object? o) => o is PastbookingRecord;
}
