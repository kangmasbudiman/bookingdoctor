...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'detailDoctor',
          path: '/detailDoctor',
          builder: (context, params) => DetailDoctorWidget(
            pupularDoctorref: params.getParam('pupularDoctorref',
                ParamType.DocumentReference, false, ['populardcoctor']),
          ),
        ),
        FFRoute(
          name: 'myBooking',
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'myBooking')
              : MyBookingWidget(),
        ),
        FFRoute(
          name: 'ChatPage',
        ...
        FFRoute(
          ...
          path: '/doctorPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'DoctorPage')
              : DoctorPageWidget(),
        ),
        FFRoute(
          name: 'doctorSetting',
          path: '/doctorSetting',
          builder: (context, params) => DoctorSettingWidget(),
        ),
        FFRoute(
          name: 'adminPanel',
          path: '/adminPanel',
